...
- **`List_Generation.cs`**: Converting Text Sequence into List 
[List_Generation.cs](https://github.com/mahbub-khan/neocortexapi_SDR_Decoder_3.7/blob/master/source/Samples/NeoCortexApiSample/List_Generation.cs)
...
![Methodology Flowchart](https://github.com/mahbub-khan/neocortexapi_SDR_Decoder_3.7/blob/master/source/SDRDecoder3.7Project/Documentation/F1%20Workflow.png)
...
[SDR generation using scaler Encoder](https://github.com/mahbub-khan/neocortexapi_SDR_Decoder_3.7/blob/master/source/SDRDecoder3.7Project/Documentation/Demo/WordTokenization/Scaler_Encoder.cs)
...
```
`ConvertToBinarySDR` method takes a list of active indices (activeIndices) and the total size of the output SDR Converts a list of active indices (sparse representation) into a binary SDR vector.
